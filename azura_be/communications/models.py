...
class CommunicationMessage(BaseModel):
    ...
    account = models.ForeignKey(
        BusinessAccount, on_delete=models.CASCADE, related_name="communications"
    )
    ...
    def send(self):
        ...
        if self.type == CommunicationMessageType.SMS_TEXT:
...
class Thread(BaseModel):
    ...
    created_by = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, related_name="created_threads"
    )
...
class ThreadUser(BaseModel):
    thread = models.ForeignKey(
        Thread, on_delete=models.CASCADE, related_name="thread_users"
    )
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="user_threads"
    )
    added_by = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="added_threads_users",
    )
...
class ThreadMessage(BaseModel):
    ...
    user = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="thread_messages_send",
    )
...
class ThreadAttachment(BaseModel):
    thread_message = models.ForeignKey(
        ThreadMessage,
        on_delete=models.CASCADE,
        related_name="thread_message_attachments",
    )
