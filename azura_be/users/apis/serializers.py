...
class UserDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ("id", "email", "first_name", "last_name", "phone", "picture", "timezone", "role", "two_factor_auth")
...
class UserCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ("first_name", "last_name", "email", "picture", "timezone", "email_noftification", "sms_notification", "auto_form_save", "provider_groups", "departments", "primary_location", "phone", "role", "account_user", "two_factor_auth")

class LicenseSerializer(serializers.ModelSerializer):
    class Meta:
        model = License
        fields = ("user", "number", "state", "exiry_date", "npi", "dea_number", "specialties")
