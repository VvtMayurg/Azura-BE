...
class TaskUpdateSerializer(serializers.ModelSerializer):
    class Meta:
        model = Task
        fields = ("reason", "patient", "user", "due_at", "priority", "description", "completed", "completed_at")
    ...
    def validate(self, attrs):
        ...
        if completed_at and due_at > completed_at:
            raise serializers.ValidationError(detail={"completed_at": "Completed date time can not be greater than due date time"})
        return attrs
