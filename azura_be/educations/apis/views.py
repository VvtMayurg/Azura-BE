...
from azura_be.educations.apis.serializers import EducationSerializer, EducationCreateSerializer, AssignUnassignPatientEducationSerializer
...
class EducationViewSet(viewsets.ModelViewSet):
    ...
    def assign_unassign(self, request, *args, **kwargs):
        ...
        serializer = AssignUnassignPatientEducationSerializer(data=request.data, context={"education": education})
        serializer.is_valid(raise_exception=True)
        serializer.save()

    @action(detail=True, methods=["GET"], url_path="assigned-patients", pagination_class=None)
