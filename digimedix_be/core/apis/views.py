...
from digimedix_be.base.filterset_classes import SpecialtyFilter
from digimedix_be.core.apis.serializers import SpecialtyGetSerializer, SpecialtyPostSerializer
